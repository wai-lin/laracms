<x-layouts.waffle title="Where Ideas Get Crispy">
    {{-- Hero Section --}}
    <div class="text-center mb-16">
        <h1 class="text-5xl lg:text-7xl font-black text-gray-800 mb-6 leading-tight">
            We make your ideas<br>
            <span class="squiggle">golden & crispy</span>
        </h1>
        <p class="text-xl lg:text-2xl text-gray-600 mb-10 max-w-2xl mx-auto">
            A creative studio that cooks up digital experiences with a side of syrup. 
            Web design, branding, and apps made fresh daily.
        </p>
    </div>
    ...
    <div id="work" class="grid md:grid-cols-3 gap-6 mb-20">
        <div class="bg-white p-8 rounded-2xl border-3 border-gray-800 waffle-shadow transition-all">
            ...
            <h3 class="text-xl font-bold text-gray-800 mb-2">Brand Design</h3>
            <p class="text-gray-600">Logos, colors, and vibes that make your brand unforgettable.</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl border-3 border-gray-800 waffle-shadow transition-all">
            ...
            <p class="text-gray-600">Fast, beautiful websites that work on every device. No crumbs left behind.</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl border-3 border-gray-800 waffle-shadow transition-all">
            ...
            <p class="text-gray-600">Apps that users actually want to open. Smooth like butter.</p>
        </div>
    </div>
